        ...
        <div role="tabpanel" class="tab-pane active div_center70" id="info">
        	<table class="table table-hover">
        		...
        		<tbody>
        			...
        			<tr>
        				<td class="text-right" colspan="2"><a class="btn-block" href="#">Editar</a></td>
        			</tr>
        		</tbody>
        	</table>
        	<table class="table table-hover text-center">
        		...
        		<tbody>
        			<tr>
        				...
        				<td>**********</td>
        				<td class="text-right"><a href="">Editar</a></td>
        			</tr>
        		</tbody>
        	</table>
        	<table class="table table-hover text-center">
        		...
        		<div class="preicfes_test">
        			...
        			<div class="div_center70">
        				...
        				<div class="row">
								...
								<div class="col-md-9">
									<div class="progress">
											<div class="progress-bar" role="progressbar" aria-valuenow="{!!$result->total_score!!}" aria-valuemin="0" aria-valuemax="500" style="width: {!!round(($result->total_score * 100)/(count($result->pre_icfes->areas)*100))!!}%;">
												<span>{!! $result->total_score.' Puntos de '.(count($result->pre_icfes->areas)*100) !!}</span>
										</div>
									</div>
								</div>
							</div>
