...
@section('page_title')
	Editar PreICFES | <i class="fa fa-book"></i> {{ $preicfes->name }}
@endsection
...
@section('breadcrums')
	<ol class="breadcrumb">
	  ...
	  <li class="active"><a href="{{ route('admin.preicfes.show', $preicfes->id)}}">{{ $preicfes->name }}</a></li>
...
@section('row')
	...
	{!! Form::open(['route' => ['admin.preicfes.update', $preicfes], 'method'=> 'PUT']) !!}
		<div class="row">
